...
public class PageController {
	...
	public ModelAndView index() {		
		...
		mv.addObject("categories", categoryDAO.list()); //categories is mapped in sidebar page
	...
	public ModelAndView showAllProducts() {		
		...
		mv.addObject("categories", categoryDAO.list()); //for availability of sidebar categories on products page
