package net.aish.onlineshopping.handler;
...
import net.aish.onlineshopping.model.CheckoutModel;
import net.aish.onlineshopping.model.UserModel;
import net.aish.onlineshoppingbackend.dao.CartLineDAO;
import net.aish.onlineshoppingbackend.dao.ProductDAO;
import net.aish.onlineshoppingbackend.dao.UserDAO;
...
import net.aish.onlineshoppingbackend.dto.OrderItem;
